...
Revises custom_0004 (not the literal '0107') because our fork already has
its own '0107' (guest_purchase_personalized_tgid, deployed in production
under that id) — the upstream idempotency migration that used to be '0107'
was renamed to custom_0004 to avoid the id collision. See custom_0004's
docstring.
...
revision: str = '0108'
down_revision: Union[str, None] = 'custom_0004'
